...
CREATE ALIAS IF NOT EXISTS "unaccented_lower" AS '
...
ALTER TABLE "common"."auditable" ADD CONSTRAINT IF NOT EXISTS "pk_auditable" PRIMARY KEY ("id");

CREATE INDEX IF NOT EXISTS "dx_auditable_created_at" ON "common"."auditable" ("created_at");
CREATE INDEX IF NOT EXISTS "dx_auditable_updated_at" ON "common"."auditable" ("updated_at");

CREATE TABLE IF NOT EXISTS "common"."non_auditable"
(
    "id"           UUID         NOT NULL,
    "string_value" VARCHAR(250) NOT NULL,
    "int_value"    INT          NOT NULL
...
ALTER TABLE "common"."non_auditable" ADD CONSTRAINT IF NOT EXISTS "pk_non_auditable" PRIMARY KEY ("id");

CREATE TABLE IF NOT EXISTS "common"."searchable"
(
    "id"           UUID         NOT NULL,
    "string_value" VARCHAR(250) NOT NULL,
    "int_value"    INT          NOT NULL
...
ALTER TABLE "common"."searchable" ADD CONSTRAINT IF NOT EXISTS "pk_searchable" PRIMARY KEY ("id");

CREATE TABLE IF NOT EXISTS "common"."parent"
(
    "id"           UUID         NOT NULL,
    "string_value" VARCHAR(250) NOT NULL,
    "int_value"    INT          NOT NULL
...
ALTER TABLE "common"."parent" ADD CONSTRAINT IF NOT EXISTS "pk_parent" PRIMARY KEY ("id");

CREATE TABLE IF NOT EXISTS "common"."child"
(
    "id"           UUID         NOT NULL,
    "string_value" VARCHAR(250) NOT NULL,
    "int_value"    INT          NOT NULL,
...
ALTER TABLE "common"."child" ADD CONSTRAINT IF NOT EXISTS "pk_child" PRIMARY KEY ("id");
ALTER TABLE "common"."child" ADD CONSTRAINT IF NOT EXISTS "fk_child_parent" FOREIGN KEY ("parent_id") REFERENCES "common"."parent" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT;

CREATE TABLE IF NOT EXISTS "simple"."enumerated"
(
    "id"            UUID         NOT NULL,
...
ALTER TABLE "simple"."enumerated" ADD CONSTRAINT IF NOT EXISTS "pk_enumerated" PRIMARY KEY ("id");

CREATE TABLE IF NOT EXISTS "simple.simple_model"
(
    "id"            UUID         NOT NULL,
    "string_value"  VARCHAR(250) NOT NULL,
    "boolean_value" BOOLEAN      NOT NULL,
...
ALTER TABLE "simple.simple_model" ADD CONSTRAINT IF NOT EXISTS "pk_simple_model" PRIMARY KEY ("id");
