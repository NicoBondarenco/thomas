package com.thomas.mongodb.data
...
val foundDateMin: Instant = Instant.parse("1990-04-28T00:00:00.000Z")
val foundDateMax: Instant = Instant.parse("1990-04-30T23:59:59.999Z")
...
val entityListFoundData: List<TestMongoEntity>
    get() = (1..20).map {
        TestMongoEntity(
...
val entityListNotFoundData: List<TestMongoEntity>
    get() = (1..15).map { value ->
        TestMongoEntity(
            stringValue = randomUUID().toString(),
