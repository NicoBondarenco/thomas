...
import com.thomas.mongodb.sync.data.ChildTestEntity
import com.thomas.mongodb.sync.data.ParentTestEntity
import com.thomas.mongodb.sync.data.ParentTestRepository
import com.thomas.mongodb.sync.data.TestMongoEntity
import com.thomas.mongodb.sync.data.TestMongoRepository
import com.thomas.mongodb.sync.data.childTestList
import com.thomas.mongodb.sync.data.entityListFoundData
import com.thomas.mongodb.sync.data.entityListNotFoundData
import com.thomas.mongodb.sync.data.foundDateMax
import com.thomas.mongodb.sync.data.foundDateMin
import com.thomas.mongodb.sync.data.fullTestEntity
import com.thomas.mongodb.sync.data.parentTestEntity
...
class MongoSyncRepositoryTest {
    ...
    fun beforeAll() {
        ...
        mongoDatabase = MongoSyncDatabaseFactory.create(properties)
