...
import com.thomas.spring.serialization.AspectAnnotationIntrospector
...
class JacksonConfiguration {
    ...
    @Bean
    fun objectMapper(): ObjectMapper = ObjectMapper().configureDefaults(SNAKE_CASE)

    @Bean("aspect-mapper")
    fun aspectMapper(): ObjectMapper = ObjectMapper()
        .setAnnotationIntrospector(AspectAnnotationIntrospector()) // order matters
        .configureDefaults(LOWER_CAMEL_CASE)
