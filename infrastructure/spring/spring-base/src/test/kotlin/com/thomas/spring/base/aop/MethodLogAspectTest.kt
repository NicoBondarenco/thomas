...
//    private val realLogger = KotlinLogging.logger {}
//
...
//    fun beforeAll() {
//        currentUser = user
//        every { logger.at(any<Level>(), any<String>()) } answers {
